...
const createReservationAPI = async (reservationData) => {
  try {
    const response = await fetch(`${API_BASE_URL}/alive/reserve`, {
      method: 'POST',
      ...
      <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
        <div className="modal-container">
          ...
          <div className="form-panel">
            ...
            <div className="form-group"><input type="tel" name="mobile" className="form-input" placeholder="Mobile (WhatsApp)" value={formData.mobile} onChange={(e) => {
